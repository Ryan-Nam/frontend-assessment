...
.main-banner .mindarc-hero {
    position: relative;
}

.main-banner .mindarc-hero::before {
    content: '';
    position: absolute;
    top: 0;
    right: 0;
    bottom: 0;
    left: 0;
    background-color: var(--mindarc-hero-bg);
    z-index: 1;
}
...
.mindarc-shadow {
    box-shadow: 0 -1px 4px 0 rgba(0, 0, 0, 0.05), 0 -1px 12px 0 rgba(0, 0, 0, 0.03);
}
